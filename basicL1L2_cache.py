...
def calculate_energy(stats):
        energy_factors = {
            ...
            'icache_access': Decimal('0.342374'),
            'icache_miss': Decimal('0.527789'),
            'dcache_access': Decimal('0.439102'),
            'dcache_miss': Decimal('1.18412'),
            'l2_access': Decimal('5.4862'),
            'l2_miss': Decimal('11.5374'),
        }
        energy = Decimal('0.0')
